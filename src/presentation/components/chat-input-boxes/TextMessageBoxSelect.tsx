    ...
    >
     <div className="flex-grow">
       <div className="flex">
          ...
          <select 
          name="select"
          className="w-2/5 ml-5 boder rounded-xl text-gray-800 focus:outline-none focus:border-indigo-300 pl-4 h-10"
          value={ selectedOption }
          onRateChange={ e => setSelectedOption (e.target.value) }
          >
